    ...
    return (
        <LogoWrapper margin={margin ?? null} size={size ?? null} >
            <svg width="100%" height="100%" preserveAspectRatio="none" viewBox="0 0 178 178" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M61 41C69.8333 46.3333 93.8 56 119 52C144.2 48 157.5 45.5 165 51" stroke="#6FCF97" stroke-width="8" />
                <path d="M43.5 40.5C56.5 51.5 82.6484 69.8945 93 73C103 76 114.171 78.7912 144.5 75C152.5 74 173 81 174 85.5" stroke="#6FCF97" stroke-width="8" />
                <path d="M27 34.5001C34.8333 39.5001 57 46.5001 83 34.5001C115.5 19.5001 134.5 23.5 147.5 28" stroke="#6FCF97" stroke-width="8" />
                <path d="M9.5 65.5C17.5 71.3333 36.3308 79.1406 51.5 75.5C64 72.5 85.1667 71 92 72.5" stroke="#6FCF97" stroke-width="8" />
